            ...
            <div class="flex flex-row justify-between">
                <div class="">
                    ...
                    <div class="flex flex-col gap-3">
                        <span class="inline-flex items-center justify-center px-4 py-2 rounded-full text-sm font-medium bg-green-100 text-green-800">
                            @if( \Carbon\Carbon::now() < \Carbon\Carbon::parse($data['tournament']->start_date)->subDays(2) && $data['tournament']['current_teams']< $data['tournament']['max_teams'])
                            <span>
                            Registration Open
                            </span>
                            @else
                        ...
                        <button id="generateMatch"  class="inline-flex items-center px-6 py-3 rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-200 ">
                            Generate Matches
                        </button>
                    </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
                    ...
                    <div class="mt-4 flex justify-end">
                        <a href="{{route('getTeamPlayers',['id'=>$team['id']])}}" class="text-sm text-blue-600 hover:text-blue-800 font-medium">
                            View Details →
                        </a>
                    </div>
                </div>
